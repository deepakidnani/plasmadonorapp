...
def requested():
    ...
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulk?authorization=0WM2jqY3n49FpPSBdlG1AUTkrhb8eQ7IEfDLwtzNymvXRoiH6gPfLrzgV2xecTJywdCjA9QFBv6Y0KsM&sender_id=FSTSMS&message=Need Plasma of your blood group&language=english&route=p&numbers="+str(i['phone'])
